...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 20 jan. 2023 à 11:23
...
(1, 'chelihi', 'sofiane', 'admin', 21, '2022-12-11', 'm', 'admin', 'e92f09f072feaeedc026bb585d9b6ff5');
...
(1, 'http://localhost/Projet_TDW/public/assets/images/new2.webp', 'http://localhost/Projet_TDW/public/news/affiche_page_new&id_news=9'),
(2, 'http://localhost/Projet_TDW/public/assets/images/news.jpg', 'http://localhost/Projet_TDW/public/news/affiche_page_new&id_news=11'),
...
('pourcentage_nb_ingr_healthy', 0.6);
...
(1, 'sofian', 'chelihi', 'js_chelihi@esi.dz', '2001-11-07', 'm', '123', 1, 'ca33f26c03008cb43500a21c258e4762'),
(3, 'chelihi', 'rayan', 'rayan@esi.dz', '2001-11-05', 'm', '123', 1, ' '),
(6, 'hadil', 'chelihi', 'sofianmilanou3@gmail.com', '2001-11-06', 'm', '123', 1, '49cd63502e352fe095496e4b396782fe');
...
--
ALTER TABLE `info_nutr`
  MODIFY `id_info` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT pour la table `ingredient`
--
ALTER TABLE `ingredient`
  MODIFY `id_ingr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
